...
from logica_jogos import rodar_ppt
...
def ped_pap_tes():
    ...
    if request.method == "POST":
        form_usuario = request.form.get("escolha") # 'pedra', 'papel' ou 'tesoura'

    # Chamada da função do pedra, papel e tesoura, do arquivo logica_jogos.py
    escolha_usuario, escolha_computador, resultado = rodar_ppt(form_usuario) 
